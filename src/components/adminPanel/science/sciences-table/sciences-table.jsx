...
import "./sciences-table.scss";
import { updateData } from '@/services/update';
import { deleteData } from '@/services/delete';
import { AccessContext } from '@/contexts/contexts';
import AddScience from '../add-science/add-science';
import AddScienceSection from '../add-science-section/add-science-section';
                                ...
                                <ul>
                                    {
                                        (subjectSections[subject.id] && subjectSections[subject.id].length > 0) ? (
                                            ...
                                            <p>Bu fanga tegishli bo‘limlar mavjud emas!</p>
                                        )
                                    }
